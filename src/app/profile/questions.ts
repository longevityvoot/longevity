...
export const QUESTIONS = {
  ...
  sectionB: [
    { id: 'B1',  dim: 'D1', reverse: false, text: 'เมื่อวางแผนไว้แล้ว ฉันมักทำตามได้จนสำเร็จ' },
    { id: 'B2',  dim: 'D1', reverse: false, text: 'ฉันมีเวลาตื่นนอนและเข้านอนที่แน่นอน แม้ในวันหยุด' },
    { id: 'B3',  dim: 'D1', reverse: true,  text: 'ฉันปรับเปลี่ยนแผนระหว่างวันได้ง่าย โดยไม่รู้สึกกังวล' },
    { id: 'B4',  dim: 'D2', reverse: false, text: 'ฉันรู้สึกมีพลังมากขึ้นหลังจากใช้เวลากับคนอื่น' },
    { id: 'B5',  dim: 'D2', reverse: false, text: 'ฉันทำกิจกรรมได้ดีขึ้นเมื่อมีคนร่วมทำด้วย' },
    { id: 'B6',  dim: 'D2', reverse: true,  text: 'หลังวันที่เหนื่อย ฉันอยากอยู่คนเดียวเพื่อพักผ่อน' },
    { id: 'B7',  dim: 'D3', reverse: false, text: 'ฉันชอบติดตามตัวเลขเกี่ยวกับสุขภาพของตัวเอง' },
    { id: 'B8',  dim: 'D3', reverse: false, text: 'ฉันใช้แอปหรืออุปกรณ์วัดสุขภาพเป็นประจำ' },
    { id: 'B9',  dim: 'D3', reverse: true,  text: 'ฉันตัดสินใจเรื่องสุขภาพจากความรู้สึกของร่างกายมากกว่าตัวเลข' },
    { id: 'B10', dim: 'D4', reverse: true,  text: 'ฉันกินอาหารซ้ำเดิมได้เป็นสัปดาห์โดยไม่รู้สึกเบื่อ' },
    { id: 'B11', dim: 'D4', reverse: false, text: 'ฉันชอบลองออกกำลังกายหรือกิจกรรมแบบใหม่ๆ' },
    { id: 'B12', dim: 'D4', reverse: true,  text: 'ฉันรู้สึกสบายใจเมื่อมีตารางชีวิตที่คาดเดาได้' },
    { id: 'B13', dim: 'D5', reverse: false, text: 'ฉันรู้สึกตื่นตัวและคิดอะไรได้ดีที่สุดในช่วงเช้า' },
    { id: 'B14', dim: 'D5', reverse: true,  text: 'ฉันทำงานหรือคิดเรื่องยากๆ ได้ดีในช่วงกลางคืน' },
    { id: 'B15', dim: 'D5', reverse: true,  text: 'ช่วงหลังสามทุ่มเป็นเวลาที่ฉันทำอะไรได้หลายอย่าง' },
    { id: 'B16', dim: 'D6', reverse: true,  text: 'ฉันต้องเห็นความก้าวหน้าบ่อยๆ ถึงจะมีกำลังใจทำต่อ' },
    { id: 'B17', dim: 'D6', reverse: false, text: 'ฉันทำสิ่งที่ยังไม่เห็นผลลัพธ์ได้ต่อเนื่องเป็นเดือน' },
    { id: 'B18', dim: 'D6', reverse: false, text: 'เป้าหมายระยะยาวมีพลังกับฉันมากกว่าผลลัพธ์ในวันพรุ่งนี้' },
