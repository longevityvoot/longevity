...
export const QUESTIONS = {
  ...
  sectionB: [
    { id: 'B1',  dim: 'D1', reverse: false, text: 'เมื่อตั้งใจจะทำอะไร ฉันมักทำได้ตามแผน ไม่ค่อยหลุด' },
    { id: 'B2',  dim: 'D1', reverse: false, text: 'ฉันชอบตื่นและนอนเวลาเดียวกันทุกวัน — รวมถึงวันหยุด' },
    { id: 'B3',  dim: 'D1', reverse: false, text: 'ถ้ามีคนชวนเปลี่ยนแผนกระทันหัน ฉันรู้สึกอึดอัด' },
    { id: 'B4',  dim: 'D2', reverse: false, text: 'หลังวันที่ยุ่ง ฉันต้องการเวลาคนเดียวเพื่อชาร์จพลัง' },
    { id: 'B5',  dim: 'D2', reverse: false, text: 'ฉันออกกำลังกายได้นานกว่า เมื่อมีเพื่อนออกมาด้วยกัน' },
    { id: 'B6',  dim: 'D2', reverse: true,  text: 'การกินข้าวคนเดียวเป็นเวลาที่ดี ไม่ใช่เรื่องเหงา' },
    { id: 'B7',  dim: 'D3', reverse: false, text: 'ฉันชอบเห็นตัวเลขความก้าวหน้าของตัวเอง' },
    { id: 'B8',  dim: 'D3', reverse: false, text: 'เครื่องชั่ง / smart watch / แอป ช่วยให้ฉันดูแลสุขภาพได้แม่นยำขึ้น' },
    { id: 'B9',  dim: 'D3', reverse: true,  text: 'ถึงไม่มีข้อมูล ฉันยังตัดสินเรื่องสุขภาพได้ดี' },
    { id: 'B10', dim: 'D4', reverse: false, text: 'กินอาหารแบบเดิมๆ ทุกสัปดาห์ได้ ไม่เบื่อ' },
    { id: 'B11', dim: 'D4', reverse: true,  text: 'ฉันชอบลองออกกำลังกายแบบใหม่ๆ' },
    { id: 'B12', dim: 'D4', reverse: false, text: 'ตารางชีวิตที่คาดเดาได้ ทำให้ฉันสบายใจ' },
    { id: 'B13', dim: 'D5', reverse: false, text: 'ฉันรู้สึก sharp ที่สุดในช่วงเช้า' },
    { id: 'B14', dim: 'D5', reverse: true,  text: 'ถ้าต้องคิดงานยากตอนกลางคืน ฉันทำได้ดี' },
    { id: 'B15', dim: 'D5', reverse: true,  text: 'ฉันมีกิจกรรมที่ productive ช่วงหลัง 21:00' },
    { id: 'B16', dim: 'D6', reverse: true,  text: 'เห็นผลเล็กๆ ทุกสัปดาห์ ทำให้ฉันมีแรงทำต่อ' },
    { id: 'B17', dim: 'D6', reverse: false, text: 'ฉันทำสิ่งที่ไม่เห็นผลทันทีได้นานเป็นเดือน' },
    { id: 'B18', dim: 'D6', reverse: false, text: 'ภาพอนาคต 10 ปีข้างหน้า มีพลังกับฉันมากกว่าผลพรุ่งนี้' },
  ...
  snippets: {
    ...
    D5_high: { title: 'Early Bird', th: 'เช้าคือเวลาทอง', body: 'เช้าคือเวลาทองของคุณ — sharp ที่สุด พลังเต็มที่ ระบบของคุณจะ leverage morning energy: workout 6–8 โมง, planning session ก่อนเที่ยง, social activity ช่วงกลางวัน — และนอนเร็วเพื่อรักษา rhythm' },
